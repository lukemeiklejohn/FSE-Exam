...
// let rawdata = require('./my_sneakers.json');
// let sneakerdata = JSON.parse(rawdata);
// console.log(rawdata);
...
var html = {};
// $.getJSON("my_sneakers.json", function(data){ 
//     html = (data);
//     console.log('html in function', html)
//     console.log(data)
// });
...
document.getElementById("btn").addEventListener("click", function(e){
  ...
  if(invalidForm == 0) {
    ...
    writeFile("my_sneakers.json", "test")
